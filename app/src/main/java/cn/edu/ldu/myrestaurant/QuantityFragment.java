 ...
 * {@link QuantityFragment.OnQuantityFragmentListener} interface
...
public class QuantityFragment extends Fragment {
    ...
    private OnQuantityFragmentListener mListener;
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onQuantityFragmentComplete(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnQuantityFragmentListener) {
            mListener = (OnQuantityFragmentListener) context;
        } else {
            throw new RuntimeException(context.toString()
                    + " must implement OnQuantityFragmentListener");
        }
    }
     ...
     */
    public interface OnQuantityFragmentListener {
        // TODO: Update argument type and name
        void onQuantityFragmentComplete(Uri uri);
    }
}
